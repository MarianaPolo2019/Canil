<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="Inserir.aspx.cs" Inherits="Canil.Inserir" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="text-center text-primary">Cadastro do Pet</div>
    <div class="container">
    ...
    <div class="row" style="margin-top:15px">
        ...
        <div class="col-md-3">
            ...
            <asp:RequiredFieldValidator ID="rfvDatPag" ControlToValidate="txtData"
                ErrorMessage="*" ForeColor="Red" runat="server"></asp:RequiredFieldValidator>
            <asp:TextBox ID="txtData" placeholder="Dia/Mês/Ano" runat="server" CssClass="form-control"></asp:TextBox>
        </div>
        <div class="col-md-3">
            <label>Valor a Pagar: </label>
            <asp:RequiredFieldValidator ID="rfvValor" ControlToValidate="txtValor"
                ErrorMessage="*" ForeColor="Red" runat="server"></asp:RequiredFieldValidator>
            <asp:TextBox ID="txtValor" runat="server" CssClass="form-control"></asp:TextBox>
        </div>
        <div class="col-md-3">
            <label>Forma de Pagamento: </label>
            <asp:RequiredFieldValidator ID="rfvFormaPag" ControlToValidate="txtFormaPag"
                ErrorMessage="*" ForeColor="Red" runat="server"></asp:RequiredFieldValidator>
            <asp:TextBox ID="txtFormaPag" runat="server" MaxLength="100" CssClass="form-control"></asp:TextBox>
        </div>
    </div>
    <div class="row" style="margin-top:15px;">
