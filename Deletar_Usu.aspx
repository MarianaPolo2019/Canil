<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="Deletar_Usu.aspx.cs" Inherits="Canil.Deletar_Usu" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row" style="margin-top:15px">
        <div class="col-md-6 text-right">
            <asp:Button ID="btnDeletar" runat="server" CssClass="btn btn-danger" OnClick="btnDeletar_Click"></asp:Button>
        </div>
        <div class="col-md-6">
