<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="Usuarios.aspx.cs" Inherits="Canil.Usuarios" %>
                ...
                <tr>
                    ...
                    <td>
                        <asp:LinkButton ID="lnkDetalhes" runat="server">
                            <a href='<%# Eval("id", "Detalhes_Usu.aspx?id={0}") %>'>
                                <span class="fas fa-eye"></span>
                            </a>
                        </asp:LinkButton>
                        <asp:LinkButton ID="lnkEditar" runat="server">
                            <a href='<%# Eval("id", "Editar_Usu.aspx?id={0}") %>'>
                                <span class="fas fa-pencil-alt"></span>
                            </a>
                        </asp:LinkButton>
                        <asp:LinkButton ID="lnkRemover" runat="server">
                            <a href='<%# Eval("id", "Deletar_Usu.aspx?id={0}") %>'>
